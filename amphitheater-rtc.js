/* mca-rtc.js — Silver Lake Amphitheater (AEHub) NATIVE video conferencing (own WebRTC, no third party)
   ------------------------------------------------------------------------
...
(function () {
  ...
  var API = (window.AMPHITHEATER_API||'https://ae-connect-api.vercel.app')+'/api/connect';
  ...
  window.AmphMeet = ESPOAPI; window.MCAMeet = ESPOAPI; window.ESPOMeet = ESPOAPI; window.LCPMeet = ESPOAPI;
})();
